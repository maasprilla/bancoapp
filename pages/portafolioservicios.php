...
<head>
	...
	<link rel="stylesheet" href="css/portafolioservicios.css">
	...
	<header>
		...
		<section id="Identity" class="IdentityPanelMajor-container">
			<div class="container IdentityPanelContainer">
				<ul class="nav nav-tabs IdentityPanel-items" role="tablist">
					<li role="presentation" class="IdentityPanel-list active"><a href="#objetivo" aria-controls="objetivo" class="IdentityPanel-link" role="tab" data-toggle="tab">Objetivo</a></li>
					<li role="presentation" class="IdentityPanel-list"><a href="#identidadcorp" aria-controls="identidadcorp" class="IdentityPanel-link" role="tab" data-toggle="tab">Identidad corporativa</a></li>
					<li role="presentation" class="IdentityPanel-list"><a href="#valorescorp" aria-controls="valorescorp" class="IdentityPanel-link" role="tab" data-toggle="tab">Valores corporativos</a></li>
				</ul>
